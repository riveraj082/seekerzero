...
- Windows working tree is canonical for builds; a0prod mirror at `$HOME/agent-zero-data/projects/seekerzero/` must be kept in sync via `tar | ssh` after each meaningful change.
